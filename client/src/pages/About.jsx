  ...
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-4 text-slate-700 text-justify'>
        ...
        exceptional service and making the buying and selling process as smoothe as possible
      </p>
      <p className='mb-4 text-slate-700 text-justify'>
        ...
        Whether you are looking to buy, sell or rent a property, we are here to help you
        every steop of the way.
      </p>
      <p className='mb-4 text-slate-700 text-justify'>
        Our team of agents has a wealth of experience and knowledge in the real estate industry,
        and we are commited to providing the highest level of service to our clients. 
        We believe that buying or selling a property should be an exciting and rewarding
